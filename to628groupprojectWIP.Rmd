...
# Acutally we also tried step model and non-linear models, though it seems sensible that some predictors in the model are non-linear, the confusionmatrix did not show better performance. Hence, we remain the simple linear model.
```
